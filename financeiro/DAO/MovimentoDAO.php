...
{
    public function RealizarMovimento($tipo, $data, $valor, $observacao, $categoria, $empresa, $conta)
    {
        if ($tipo ==  '' || trim($data) == '' || $valor == '' || $categoria == '' || $empresa == '' || $conta == '') {
            return 0;
        } else {
            $conexao = parent::retornarConexao();
            $comando_sql = 'insert into tb_movimento (tipo_movimento, data_movimento, valor_movimento, obs_movimento, id_empresa, id_conta, id_categoria, id_usuario) 
            values(?,?,?,?,?,?,?,?)';
    ...
    public function ConsultarMovimento($tipo, $dataInicio, $dataFinal)
    {
